...
def add_recipe(request):
    if request.method == 'GET':
        ...
        return render(request, "new_recipe_form.html", {"ingredients": ingredients})
...
def recipe_id(request, dish_id):
    ...
    if request.method == 'GET':
        return render(request, "recipe_id_get.html", {"recipe": dish.get(id=dish_id)})
    elif request.method == 'POST':
        dish.delete()
        return redirect('/recipe')
    raise Http404
...
def add_ingredient(request):
    if request.method == 'GET':
        ...
        return render(request, "new_ingredient_form.html", {"categories": categories})
    elif request.method == 'POST':
        data = request.POST.copy()
        print(data)
...
def ingredient_id(request, ing_id):
    ...
    if request.method == 'GET':
        return render(request, "ingredient_id_get.html", {"ingredient": ing.get(id=ing_id)})
    elif request.method == 'POST':
        ing.delete()
...
def add_category(request):
    if request.method == 'GET':
        return render(request, "new_category_form.html")
    elif request.method == 'POST':
        data = request.POST.copy()
        print(data)
...
def category_id(request, cat_id):
    ...
    if request.method == 'GET':
        return render(request, "category_id_get.html", {"recipe": cat.get(id=cat_id)})
    elif request.method == 'POST':
        cat.delete()
        return redirect('/recipe')
    raise Http404
