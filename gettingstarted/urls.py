...
urlpatterns = [
    ...
    path("ingredient/<int:ing_id>/delete", hello.dish_views.ingredient_id_delete, name="ingredient_delete"),
    ...
    path("category/<int:cat_id>/delete", hello.dish_views.category_id_delete, name="category_delete"),
